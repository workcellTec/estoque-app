    ...
    try {
        ...
        onAuthStateChanged(auth, async (user) => {
            ...
            if (user) {
                ...
                // Navega já — sempre para a tela inicial (a pedido do
                // usuário, removido o "lembrar última tela" que fazia o
                // app abrir direto em telas como a calculadora sozinho).
